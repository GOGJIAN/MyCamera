...
import static com.huantansheng.easyphotos.ui.EasyCameraActivity.CAMERA_CORP_TYPE;
import static com.huantansheng.easyphotos.ui.EasyCameraActivity.CAMERA_TYPE;
...
//    private static final String TAG = "JCameraView";
    ...
    private ImageCropView mCropPhoto;
    ...
    private void initView() {
        ...
        tvCropDone = view.findViewById(R.id.tv_crop_done);
        tvCropCancel = view.findViewById(R.id.tv_crop_cancel);
        tvCancel = view.findViewById(R.id.tv_cancel);

        rlMessageCamera = view.findViewById(R.id.rl_message_camera);
        tvCameraCancel = view.findViewById(R.id.tv_camera_cancel);
...
//        }
        ...
        viewCamera.setOnClickListener(new OnClickListener() {
            @Override
            public void onClick(View v) {
                    ...
                    public void captureResult(Bitmap bitmap, boolean isVertical) {
                        if(bitmap!=null){
                            ...
                            if(cameraType==CAMERA_TYPE){
                                ...
                                rlMessageCamera.setVisibility(VISIBLE);
                            }else if(cameraType==CAMERA_CORP_TYPE){
//                                if (isVertical) {
//                                    LayoutParams layoutParams = new LayoutParams(LayoutParams.MATCH_PARENT, LayoutParams.MATCH_PARENT);
//                                    layoutParams.setMargins(0,dpToPx(activity,30),0,0);
//                                    mCropPhoto.setLayoutParams(layoutParams);
//                                }
        ...
        tvDone.setOnClickListener(new OnClickListener() {
            @Override
            public void onClick(View v) {
                if (jCameraLisenter != null && captureBitmap!=null) {
                    jCameraLisenter.captureSuccess(captureBitmap);
                }
            }
        });
        tvCropDone.setOnClickListener(new OnClickListener() {
            @Override
            public void onClick(View v) {
                if (jCameraLisenter != null && mCropPhoto.getCroppedImage()!=null) {
                    jCameraLisenter.captureSuccess(mCropPhoto.getCroppedImage());
                }
            }
        });
        tvCropCancel.setOnClickListener(new OnClickListener() {
            @Override
            public void onClick(View v) {
        ...
        tvCameraCancel.setOnClickListener(new OnClickListener() {
            @Override
            public void onClick(View v) {
